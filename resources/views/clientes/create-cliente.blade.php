...
<div class="row">
  ...
  <h2 class="font-weight-bolder mb-0">Alta de cliente</h2>
</div>
            ...
            <div class="card-header p-3 pt-2 bg-transparent">
                <form action="{{ route('cliente.store') }}" method="post">
                  ...
                  <div class="input-group input-group-outline my-3">
                    ...
                    <input class="form-control @error('apellido1') is-invalid @enderror" type="text" name="apellido1" id="apellido1" value="{{ old('apellido1') }}">
                    @error('apellido1')
                        <div class="invalid-feedback"> {{ $message }} </div>
                    @enderror
                  </div>
                  ...
                  <div class="input-group input-group-outline my-3">
                    ...
                    <input class="form-control @error('apellido2') is-invalid @enderror" type="text" name="apellido2" id="apellido2" value="{{ old('apellido2') }}">
                    @error('apellido2')
                      <div class="invalid-feedback"> {{ $message }} </div>
                    @enderror
                  </div>
                  ...
                  <div class="input-group input-group-outline my-3">
                    ...
                    <input class="form-control @error('telefono') is-invalid @enderror" type="tel" name="telefono" id="telefono" value="{{ old('telefono') }}">
                    @error('telefono')
                        <div class="invalid-feedback"> {{ $message }} </div>
                    @enderror
                  </div>
...
<!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc --><script src="{{ asset('recursos/js/material-dashboard.min.js?v=3.1.0') }}"></script>
  </body>
